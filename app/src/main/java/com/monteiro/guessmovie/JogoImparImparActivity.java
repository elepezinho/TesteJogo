...
public class JogoImparImparActivity extends AppCompatActivity implements RewardedVideoAdListener, View.OnClickListener {
    ...
    private String[] letrasCompradas = new String[26];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ação ao clicar no botão de resolver fase
    ...
    public void onStart(){
        ...
        bt_opc_2.setOnClickListener(new View
                .OnClickListener() {
            @Override
            public void onClick(View view) {
                bt_opc_2.setText("");
    ...
    private void apagarLetraComprada(){
        for (String c: respostaUsuario) {
            ...
            else if(bt_lt_26.getText().equals(c) && bt_lt_26.getVisibility()==View.VISIBLE){
                bt_lt_26.setVisibility(View.INVISIBLE);
            }
        }
    }
    ...
    private void inserirLetrasCompradas(String j, int letrasCompradas) {
            ...
            if (!resposta[25].equals("*") && letrasCompradas > cont){
                respostaUsuario[25] = resposta[25];
                cont ++;
            }
